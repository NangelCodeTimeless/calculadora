...
public class ControladorCalculadora implements ActionListener {
    ...
    private final GuiCalculadora window;
    ...
    public ControladorCalculadora(GuiCalculadora window){
        this.window = window;
    }
                ...
                if(stop != 1){
                    if(exprMath.size()>2){
                        ...
                        if(exprMath.get(0).equalsIgnoreCase("-")){
                            ArrayList<String> result = new ServicioCalculadora().calculator(exprMath);
